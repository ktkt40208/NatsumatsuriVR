...
public class WiiNonVRMovement : MonoBehaviour {
    ...
    void Update()
    {
        ...
        //〇Wii
        Vector3 moveWithWii = new Vector3(wiiMovingSide, Input.GetAxis("Vertical") * 0.25f, moveDirection.z);
        //◎VR move
        //Vector3 moveWithWii = new Vector3(wiiMovingSide * 5, -headRotation.x * 1, moveDirection.z);
